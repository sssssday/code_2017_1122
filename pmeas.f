...
!!    ii          |none          |counter
!!    timin        |none          |minute of measured weather data within hour
...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      integer :: ihour, timin, flag   !! timin changed from imin by qichun
      real :: rbsb
...
!       hrmeas = 0.
            ...
            if (ifirstpcp(k) == 0) then
              ...
              if (a /= " ") then               !subdaily precip on day
                do ii = 1, nstep
                  ...
                  timin = 0
                  a = ""
                  read (100+k,5200) iyp, idap, ihour, timin,             
     ...
     !!               stop
              ...
              do
                iyp = 0
                idap = 0
                read (100+k,5202) iyp, idap, ihour, a, timin,            
