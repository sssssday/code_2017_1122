...
!!    arrays of the forest data base added by Qichun Yang 2015. 8.14
!!~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!!    part1 photosynthesis
   
      allocate (cpnmfrst(30))
      ...
      allocate (omgaf(30))
      allocate (inicdf(30))
      allocate (avg_slaf(30)) 
      allocate (ext_nf(30))
      allocate (fcn_leafminf(30))
      allocate (raf(30))
      allocate (rbf(30))
      allocate (ko25f(30))
      allocate (kc25f(30))
      ...
      allocate (akcf(30))
      allocate (avcmxf(30))
      allocate (vpd_openf(30))
      allocate (vpd_closef(30))
      allocate (toptdf(30))
      allocate (gmaxf(30))
      allocate (gminf(30))
      allocate (chtmaxf(30))
...
!!    part2 daycent variables
        ...
        allocate (PRDX2f(30))
        allocate (PPDFf(30,4))
        allocate (CERFORf(30,3,5,3))
        allocate (DECWf(30,3))
        allocate (FCFRACf(30,5,2))  !! this variable read the third column first
        allocate (TFRTCNf(30,2))
		allocate (TFRTCWf(30,2))
		allocate (LEAFDRf(30,12))
        allocate (BTOLAIf(30))
        allocate (KLAIf(30))
        allocate (LAITOPf(30))
        allocate (MAXLAIf(30))
        allocate (MAXLDRf(30))
        allocate (FORRTFf(30,3))
        allocate (SAPKf(30))
        allocate (SWOLDf(30))
        allocate (WDLIGf(30,6))
        allocate (WOODDRf(30,6))
        allocate (WRDSRFCf(30))
        allocate (WMRTFRACf(30))
        allocate (SNFXMX2f(30))
        allocate (DEL13Cf(30))
        allocate (CO2IPR2f(30))
        allocate (CO2ITR2f(30))
        allocate (CO2ICE2f(30,2,3))
        allocate (CO2IRS2f(30))
        allocate (BASFC2f(30))
        allocate (BASFCTf(30))
        allocate (SITPOTf(30))
        allocate (MAXNPf(30))
        allocate (FKMRSPMXf(30,6))
        allocate (FMRSPLAIf(30,6))
        allocate (FGRESPf(30,6))
        allocate (NO3PREF2f(30))
        allocate (TLAYPGf(30))
        allocate (TMIXf(30))
        allocate (TMPLFFf(30))
        allocate (TMPLFSf(30))
        allocate (FURGDYSf(30))
        allocate (FLSGRESf(30))
        allocate (TMXTURNf(30))
        allocate (WSCOEFF2f(30,2))
        allocate (NPP2CS2f(30))
        allocate (SFAVAIL2f(30))
        allocate (pligst(2))
!!     hru level output
        ...
        allocate (brchn(mhru))
        allocate (brchp(mhru))
        allocate (largwc(mhru))
        allocate (largwn(mhru))
        allocate (largwp(mhru))
        allocate (frootjc(mhru))
        allocate (frootjn(mhru))
        allocate (frootjp(mhru))
        allocate (frootmc(mhru))
        allocate (frootmn(mhru))
        allocate (frootmp(mhru))
        allocate (csrootc(mhru))
        allocate (csrootn(mhru))
        allocate (csrootp(mhru))
        allocate (seedc(mhru))
        allocate (seedn(mhru))
        allocate (seedp(mhru))
        allocate (flai(mhru))
        allocate (f_gpp(mhru))          !gpp
        allocate (f_pgpp(mhru))         !potential gpp
        allocate (f_npp(mhru))          !npp
        allocate (f_mr(mhru))           !maitenance respiration
        allocate (f_gr(mhru))           !growth respiration
        allocate (f_moist(mhru))
        allocate (carbostg(mhru))
        allocate (csrsnk(mhru))
        allocate (forstg(3,mhru))
        
        allocate (eup(6,3,mhru))
        allocate (cal_temp(11))
        allocate (tree_a2drat(3,mhru))
        allocate (eleaf(3,mhru)) 
        allocate (ebrch(3,mhru)) 
        allocate (elargw(3,mhru))
        allocate (efrootj(3,mhru))
        allocate (efrootm(3,mhru))
        allocate (ecsroot(3,mhru))
        allocate (esrsnk(3,mhru))
        allocate (co2cce(2,2,3))
        
        
        !allocate (woode(3,3,mhru))
        allocate (woode1(3,mhru))
        allocate (woode2(3,mhru))
        allocate (woode3(3,mlyr,mhru))
        
        !allocate (woodc(3,mhru))
        allocate (woodc1(mhru))
        allocate (woodc2(mhru))
        allocate (woodc3(mlyr,mhru))
        
        allocate (pwther(mhru))

        
        allocate (wood1tosom1(mhru))
        allocate (wood1tosom2(mhru))
        allocate (wood2tosom1(mhru))
        allocate (wood2tosom2(mhru))
        allocate (wood3tosom1(mlyr,mhru))
        allocate (wood3tosom2(mlyr,mhru))
        allocate (tswatlyr(mhru))
        
        allocate (rdis(20,mhru))
        
        allocate (availm(mhru,3))
       !!allocate (availm(mhru£¬3))
       !!allocate (co2crs(2,2,3))
       allocate (tavgdate(100,367,mhru)) !! first dimension is for year, second is for day
