...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
     ...
     &                      fertdb, subfile, fcstfile, bsnfile
      character (len=13) :: frstdb       !! added by Qichun Yang 2015.8.13
      character (len=1) ::  a
...
!!    initialize variables
      ...
      figfile = ""
	  bsnfile = ""
	  frstdb = ""            !! added by Qichun Yang 2015.8.13
!     septic database file
      ...
      read (23,5000) frstdb   !! added by Qichun
      read (23,5000) tilldb
      read (23,5000) pestdb
      read (23,5000) fertdb
...
!! calculate max number of years simulated, daily time increment
      ...
      call caps(plantdb)
      call caps(frstdb) !! added by Qichun Yang 2015.8.12
      call caps(fertdb)
      call caps(pestdb)
      call caps(figfile)
      call caps(tilldb)
