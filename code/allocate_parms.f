...
!!     hru level output
        ...
        allocate (forstg(mhru,3))
        allocate (availm(mhru,3))
        allocate (eup(mhru,6,3))
        allocate (cal_temp(11))
        allocate (tree_a2drat(mhru,3))
        allocate (eleaf(mhru,3)) 
        allocate (ebrch(mhru,3)) 
        allocate (elargw(mhru,3))
        allocate (efrootj(mhru,3))
        allocate (efrootm(mhru,3))
        allocate (ecsroot(mhru,3))
        allocate (esrsnk(mhru,3))
        allocate (co2cce(2,2,3))
        allocate (woode(mhru,3,3))

        allocate (woodc(mhru,3))
