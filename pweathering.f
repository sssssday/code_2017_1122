       subroutine pweather
        ...
        real :: parentp, pfine
        real :: clay, silt
        real :: xx, sdth ! soil layer depth; soil profile depth
        real :: parentplyr !P available in a specific soil layer
        ...
        do k = 1, sol_nly(j)
           ...
           ftem = max((11.75+(29.7/3.14)*atan(3.14*0.031*(stem-15.4)))/normalizer, 0.01)
           ...
           parentplyr = parentp * xx / sdth   !! assume phosphorus distributed evently from soil surface to bottom
            ...
            !
           pwr = 10.*parentplyr*teff*ftem*fwater/365.0  !! convert from g P/m2 to kg P/ha
